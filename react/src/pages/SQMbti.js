  ...
  const SQMbti = () => {
    ...
    return (
      ...
      <Header/>
      <div className="wrapper" style={{width: '100%', display: 'flex'}}>
      <SideBar showSideBar={showSideBar} setShowSideBar={setShowSideBar}/>
        <div className="contentwithSidebar" style={{display: 'flex', justifyContent: 'center', width: '100%', marginRight: '2.5rem'}}>
          <div className="sq-mbti">
            ...
            <Footer showSideBar={showSideBar} link={'/sq-desire'} helpContent={"자신에게 맞는 또는 가장 가까운 것 같은 MBTI를 최대 2개까지 선택할 수 있습니다."} onClickButton={onClickNext}/>
          </div>
        </div>
      </div>  
      </>

  ...
  return (
    <div id="Container" className="chContainer">
      ...
      <div className="chLinkShareWrapper">
        <Button className="shareBtn" color="#FFF" width={4} height={4}>
      ...
      <div className="chBtnWrapper">
        <Button className="chBtnGray chBtn" color="#EDEDED" width={9} height={3}>
          <span>이미지 저장</span>
        </Button>
        <Button className="chBtnPurple chBtn" color="#A570C4" width={9} height={3}>
          <span>결과 확인</span>
        </Button>
      </div>
    </div>
